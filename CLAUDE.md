...
2. Runs `tushar_v2_qld_signal.py` (QLD 2x no-margin)
...
# Delete a secret
gh secret delete EMAIL_ADDRESS
```

**Schedule:** Runs Monday-Friday at 19:30 UTC (3:30 PM EDT / 2:30 PM EST). Adjust in workflow file if needed.
