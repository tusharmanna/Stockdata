...
**Last Updated:** 2026-07-17 20:08
**Snapshot Date:** 2026-06-16

## TODAY'S SIGNALS (2026-07-17)

**Regime Gate:** BULL - 6.1% below 189d high (threshold: 15%)

**v2 Strategies:**
- TQQQ v2 (1.5x cap): Hold 0.59x | Vol: 76%
- QLD v2 (1.0x cap): 87% | Vol: 52%
...
| **Active Subtotal** | **$632,949** | **—** | **—** | **$383,704** | **$249,243** | **—** |
| **RESTRICTED/CUSTODIAL:** | | | | | | |
| Colorado 401K | $365,968 | TBD (pending) | Pending | Pending | — | HOLD |
| Eshaan Manna (Custodial) | $4,653 | Static | 100% | Current | — | HOLD |
| Shreyaan Manna (Custodial) | $2,819 | Static | 100% | Current | — | HOLD |
| Youth Account | $506 | Minimal | 100% | Current | — | HOLD |
| **Custodial Subtotal** | **$373,946** | **—** | **—** | **—** | **—** | **—** |
| **EMERGENCY RESERVE:** | | | | | | |
| Cash Management (TOD) | $6,525 | Emergency fund | 100% | $6,525 | $6,525 | HOLD |
| **GRAND TOTAL** | **$1,014,170** | **—** | **—** | **$390,229** | **$255,768** | **—** |
...
### WELLSTRADE IRA ($39,639.91)

**Strategy:** v2 QLD (Volatility-targeted, no-margin for IRA compatibility)  
**Signal Today:** 78% in QLD | Action: SCALE DOWN

| Item | Value |
|------|-------|
| Target: QLD shares | 324 shares @ $95.46 = $30,899 |
| Target: Cash | $8,741 (22% in T-bills @ ~5%) |
| Current: QLD shares | 0 (starting) |
| Current: Cash | $39,640 |
